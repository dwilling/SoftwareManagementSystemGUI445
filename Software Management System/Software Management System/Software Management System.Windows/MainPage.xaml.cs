    ...
    public sealed partial class MainPage : Page
    {
        ...
        private async void CreateAccount()
        {
            ...
            if (rows.Count == 0)
            {
                ...
                var task2 = DBConnector.ExecuteNonQueryAsync("INSERT INTO Users (Users_ID,Users_Email,Users_Password) Values (" + newID + "," + Quote(txtUserName.Text) + "," + Quote(txtPassword.Text) +")");
